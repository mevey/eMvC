...
jQuery(document).ready(function(){
	...
	if (document.body.clientHeight < window.screen.height) {
		var pageHeight = (window.screen.height - document.body.clientHeight - 40) + "px";
		if (document.getElementById("footer")) document.getElementById("footer").style.top = pageHeight;
	}
